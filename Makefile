...
# Object files:
OBJS = \
$(OBJ_DIR)/main.o $(OBJ_DIR)/Matrix.o \
$(OBJ_DIR)/MCMPC.o $(OBJ_DIR)/init.o $(OBJ_DIR)/DataStructure.o \
$(OBJ_DIR)/dynamics.o $(OBJ_DIR)/SampleBasedHessian.o $(OBJ_DIR)/costFunction.o \
##########################################################
